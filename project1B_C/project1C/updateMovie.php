	...
	<div class= "wrapper">
		...
		<form action="./updateMovie.php" method="GET">		
			<h1 class="input_fields">
				...
				MPAA Rating (Between 0.0 and 5.0): <input type="text" name="rating" value="<?php echo $row[3];?>"/><BR><BR>
		...
		if(isset($_GET['title'])) {
			...
			if(!$newMovie) {
				die ("<h3 class=\"error_Text\">Updating Movie details failed due to: " . mysql_errno() . " : " . mysql_error() . "</h3>");
			}
